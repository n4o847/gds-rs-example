...
#[test]
fn bindgen_test_layout_CUfileError() {
    const UNINIT: ::std::mem::MaybeUninit<CUfileError> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<CUfileError>(),
        8usize,
        concat!("Size of: ", stringify!(CUfileError))
    );
    assert_eq!(
        ::std::mem::align_of::<CUfileError>(),
        4usize,
        concat!("Alignment of ", stringify!(CUfileError))
    );
    assert_eq!(
        ...
        concat!(
            "Offset of field: ",
            stringify!(CUfileError),
            "::",
            stringify!(err)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).cu_err) as usize - ptr as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(CUfileError),
...
pub struct CUfileDrvProps {
    ...
    pub max_device_cache_size: ::std::os::raw::c_uint,
    pub per_buffer_cache_size: ::std::os::raw::c_uint,
    pub max_device_pinned_mem_size: ::std::os::raw::c_uint,
    pub max_batch_io_size: ::std::os::raw::c_uint,
    pub max_batch_io_timeout_msecs: ::std::os::raw::c_uint,
}
#[repr(C)]
#[derive(Debug, Default, Copy, Clone, Hash, PartialOrd, Ord, PartialEq, Eq)]
pub struct CUfileDrvProps__bindgen_ty_1 {
    ...
    pub dstatusflags: ::std::os::raw::c_uint,
    pub dcontrolflags: ::std::os::raw::c_uint,
}
#[test]
fn bindgen_test_layout_CUfileDrvProps__bindgen_ty_1() {
    const UNINIT: ::std::mem::MaybeUninit<CUfileDrvProps__bindgen_ty_1> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<CUfileDrvProps__bindgen_ty_1>(),
        32usize,
        concat!("Size of: ", stringify!(CUfileDrvProps__bindgen_ty_1))
    );
    assert_eq!(
        ::std::mem::align_of::<CUfileDrvProps__bindgen_ty_1>(),
        8usize,
        concat!("Alignment of ", stringify!(CUfileDrvProps__bindgen_ty_1))
    );
    assert_eq!(
        ...
        concat!(
            "Offset of field: ",
            stringify!(CUfileDrvProps__bindgen_ty_1),
            "::",
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).poll_thresh_size) as usize - ptr as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(CUfileDrvProps__bindgen_ty_1),
            "::",
            stringify!(poll_thresh_size)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).max_direct_io_size) as usize - ptr as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(CUfileDrvProps__bindgen_ty_1),
            "::",
            stringify!(max_direct_io_size)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).dstatusflags) as usize - ptr as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(CUfileDrvProps__bindgen_ty_1),
            "::",
            stringify!(dstatusflags)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).dcontrolflags) as usize - ptr as usize },
        28usize,
        concat!(
            "Offset of field: ",
            stringify!(CUfileDrvProps__bindgen_ty_1),
            "::",
            stringify!(dcontrolflags)
        )
    );
}
#[test]
fn bindgen_test_layout_CUfileDrvProps() {
    const UNINIT: ::std::mem::MaybeUninit<CUfileDrvProps> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<CUfileDrvProps>(),
        56usize,
        concat!("Size of: ", stringify!(CUfileDrvProps))
    );
    assert_eq!(
        ::std::mem::align_of::<CUfileDrvProps>(),
        8usize,
        concat!("Alignment of ", stringify!(CUfileDrvProps))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).nvfs) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(CUfileDrvProps),
            "::",
            stringify!(nvfs)
        )
    );
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).max_device_cache_size) as usize - ptr as usize },
        36usize,
        concat!(
            "Offset of field: ",
            stringify!(CUfileDrvProps),
            "::",
            stringify!(max_device_cache_size)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).per_buffer_cache_size) as usize - ptr as usize },
        40usize,
        concat!(
            "Offset of field: ",
            stringify!(CUfileDrvProps),
            "::",
            stringify!(per_buffer_cache_size)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).max_device_pinned_mem_size) as usize - ptr as usize },
        44usize,
        concat!(
            "Offset of field: ",
            stringify!(CUfileDrvProps),
            "::",
            stringify!(max_device_pinned_mem_size)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).max_batch_io_size) as usize - ptr as usize },
        48usize,
        concat!(
            "Offset of field: ",
            stringify!(CUfileDrvProps),
            "::",
            stringify!(max_batch_io_size)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).max_batch_io_timeout_msecs) as usize - ptr as usize },
        52usize,
        concat!(
            "Offset of field: ",
            stringify!(CUfileDrvProps),
            "::",
            stringify!(max_batch_io_timeout_msecs)
        )
    );
}
...
pub struct cufileRDMAInfo {
    ...
    pub desc_str: *const ::std::os::raw::c_char,
}
#[test]
fn bindgen_test_layout_cufileRDMAInfo() {
    const UNINIT: ::std::mem::MaybeUninit<cufileRDMAInfo> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<cufileRDMAInfo>(),
        16usize,
        concat!("Size of: ", stringify!(cufileRDMAInfo))
    );
    assert_eq!(
        ::std::mem::align_of::<cufileRDMAInfo>(),
        8usize,
        concat!("Alignment of ", stringify!(cufileRDMAInfo))
    );
    assert_eq!(
        ...
        concat!(
            "Offset of field: ",
            stringify!(cufileRDMAInfo),
            "::",
            stringify!(version)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).desc_len) as usize - ptr as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(cufileRDMAInfo),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).desc_str) as usize - ptr as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(cufileRDMAInfo),
...
pub struct CUfileFSOps {
    pub fs_type: ::std::option::Option<
        unsafe extern "C" fn(handle: *mut ::std::os::raw::c_void) -> *const ::std::os::raw::c_char,
    >,
    pub getRDMADeviceList: ::std::option::Option<
        unsafe extern "C" fn(
            handle: *mut ::std::os::raw::c_void,
            hostaddrs: *mut *mut sockaddr_t,
        ) -> ::std::os::raw::c_int,
    >,
    pub getRDMADevicePriority: ::std::option::Option<
        unsafe extern "C" fn(
            handle: *mut ::std::os::raw::c_void,
...
#[test]
fn bindgen_test_layout_CUfileFSOps() {
    const UNINIT: ::std::mem::MaybeUninit<CUfileFSOps> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<CUfileFSOps>(),
        40usize,
        concat!("Size of: ", stringify!(CUfileFSOps))
    );
    assert_eq!(
        ::std::mem::align_of::<CUfileFSOps>(),
        8usize,
        concat!("Alignment of ", stringify!(CUfileFSOps))
    );
    assert_eq!(
        ...
        concat!(
            "Offset of field: ",
            stringify!(CUfileFSOps),
            "::",
            stringify!(fs_type)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).getRDMADeviceList) as usize - ptr as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(CUfileFSOps),
            "::",
            stringify!(getRDMADeviceList)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).getRDMADevicePriority) as usize - ptr as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(CUfileFSOps),
            "::",
            stringify!(getRDMADevicePriority)
        )
    );
    assert_eq!(
...
#[test]
fn bindgen_test_layout_CUfileDescr_t__bindgen_ty_1() {
    const UNINIT: ::std::mem::MaybeUninit<CUfileDescr_t__bindgen_ty_1> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<CUfileDescr_t__bindgen_ty_1>(),
        8usize,
        concat!("Size of: ", stringify!(CUfileDescr_t__bindgen_ty_1))
    );
    assert_eq!(
        ::std::mem::align_of::<CUfileDescr_t__bindgen_ty_1>(),
        8usize,
        concat!("Alignment of ", stringify!(CUfileDescr_t__bindgen_ty_1))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).fd) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(CUfileDescr_t__bindgen_ty_1),
            "::",
            stringify!(fd)
        )
    );
...
#[test]
fn bindgen_test_layout_CUfileDescr_t() {
    const UNINIT: ::std::mem::MaybeUninit<CUfileDescr_t> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<CUfileDescr_t>(),
        24usize,
        concat!("Size of: ", stringify!(CUfileDescr_t))
    );
    assert_eq!(
        ::std::mem::align_of::<CUfileDescr_t>(),
        8usize,
        concat!("Alignment of ", stringify!(CUfileDescr_t))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).type_) as usize - ptr as usize },
        0usize,
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).fs_ops) as usize - ptr as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(CUfileDescr_t),
...
pub type CUfileHandle_t = *mut ::std::os::raw::c_void;
extern "C" {
...
extern "C" {
    pub fn cuFileBufRegister(
        devPtr_base: *const ::std::os::raw::c_void,
        length: usize,
        flags: ::std::os::raw::c_int,
    ) -> CUfileError_t;
}
extern "C" {
    pub fn cuFileBufDeregister(devPtr_base: *const ::std::os::raw::c_void) -> CUfileError_t;
}
extern "C" {
    pub fn cuFileRead(
        fh: CUfileHandle_t,
        devPtr_base: *mut ::std::os::raw::c_void,
        size: usize,
        file_offset: off_t,
        devPtr_offset: off_t,
    ) -> isize;
...
pub struct CUfileIOParams__bindgen_ty_1__bindgen_ty_1 {
    pub devPtr_base: *mut ::std::os::raw::c_void,
    pub file_offset: off_t,
    pub devPtr_offset: off_t,
    pub size: usize,
}
#[test]
fn bindgen_test_layout_CUfileIOParams__bindgen_ty_1__bindgen_ty_1() {
    const UNINIT: ::std::mem::MaybeUninit<CUfileIOParams__bindgen_ty_1__bindgen_ty_1> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<CUfileIOParams__bindgen_ty_1__bindgen_ty_1>(),
        32usize,
        concat!(
            "Size of: ",
            stringify!(CUfileIOParams__bindgen_ty_1__bindgen_ty_1)
        )
    );
    assert_eq!(
        ::std::mem::align_of::<CUfileIOParams__bindgen_ty_1__bindgen_ty_1>(),
        8usize,
        concat!(
            "Alignment of ",
            stringify!(CUfileIOParams__bindgen_ty_1__bindgen_ty_1)
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).devPtr_base) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(CUfileIOParams__bindgen_ty_1__bindgen_ty_1),
            "::",
            stringify!(devPtr_base)
        )
    );
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).devPtr_offset) as usize - ptr as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(CUfileIOParams__bindgen_ty_1__bindgen_ty_1),
            "::",
            stringify!(devPtr_offset)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).size) as usize - ptr as usize },
...
#[test]
fn bindgen_test_layout_CUfileIOParams__bindgen_ty_1() {
    const UNINIT: ::std::mem::MaybeUninit<CUfileIOParams__bindgen_ty_1> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<CUfileIOParams__bindgen_ty_1>(),
        32usize,
        concat!("Size of: ", stringify!(CUfileIOParams__bindgen_ty_1))
    );
    assert_eq!(
        ::std::mem::align_of::<CUfileIOParams__bindgen_ty_1>(),
        8usize,
        concat!("Alignment of ", stringify!(CUfileIOParams__bindgen_ty_1))
    );
    assert_eq!(
        ...
        concat!(
            "Offset of field: ",
            stringify!(CUfileIOParams__bindgen_ty_1),
            "::",
            stringify!(batch)
        )
    );
...
#[test]
fn bindgen_test_layout_CUfileIOParams() {
    const UNINIT: ::std::mem::MaybeUninit<CUfileIOParams> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<CUfileIOParams>(),
        64usize,
        concat!("Size of: ", stringify!(CUfileIOParams))
    );
    assert_eq!(
        ::std::mem::align_of::<CUfileIOParams>(),
        8usize,
        concat!("Alignment of ", stringify!(CUfileIOParams))
    );
    assert_eq!(
...
#[test]
fn bindgen_test_layout_CUfileIOEvents() {
    const UNINIT: ::std::mem::MaybeUninit<CUfileIOEvents> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<CUfileIOEvents>(),
        24usize,
        concat!("Size of: ", stringify!(CUfileIOEvents))
    );
    assert_eq!(
        ::std::mem::align_of::<CUfileIOEvents>(),
        8usize,
        concat!("Alignment of ", stringify!(CUfileIOEvents))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).cookie) as usize - ptr as usize },
        0usize,
...
pub type CUfileBatchHandle_t = *mut ::std::os::raw::c_void;
extern "C" {
